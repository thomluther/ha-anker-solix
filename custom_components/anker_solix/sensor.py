...
DEVICE_SENSORS = [
    ...
    AnkerSolixSensorDescription(
        key="power_dock_status",
        translation_key="power_dock_status",
        json_key="power_dock_state_code_2",
        device_class=SensorDeviceClass.ENUM,
        entity_category=EntityCategory.DIAGNOSTIC,
        options=[status.name for status in PowerdockStatus],
        value_fn=lambda d, jk, _: get_enum_name(
            PowerdockStatus,
            str(d.get(jk)),
            PowerdockStatus.unknown.name,
        ),
        attrib_fn=lambda d, _: {"status": d.get("power_dock_state_code_2")},
        exclude_fn=lambda s, d: not ({d.get("type")} - s),
        mqtt=True,
    ),
    AnkerSolixSensorDescription(
    ...
    AnkerSolixSensorDescription(
        key="solarbank_ac_output_power_signed_total",
        translation_key="solarbank_ac_output_power_signed_total",
        json_key="solarbank_ac_output_power_signed_total",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
    ...
    AnkerSolixSensorDescription(
        key="solarbank_1_ac_output_power_signed",
        translation_key="solarbank_1_ac_output_power_signed",
        json_key="solarbank_1_ac_output_power_signed",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
    ...
    AnkerSolixSensorDescription(
        key="solarbank_2_ac_output_power_signed",
        translation_key="solarbank_2_ac_output_power_signed",
        json_key="solarbank_2_ac_output_power_signed",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
    ...
    AnkerSolixSensorDescription(
        key="solarbank_3_ac_output_power_signed",
        translation_key="solarbank_3_ac_output_power_signed",
        json_key="solarbank_3_ac_output_power_signed",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
    ...
    AnkerSolixSensorDescription(
        key="solarbank_4_ac_output_power_signed",
        translation_key="solarbank_4_ac_output_power_signed",
        json_key="solarbank_4_ac_output_power_signed",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
    ...
    # AX170 Power Dock generator telemetry.
    AnkerSolixSensorDescription(
        key="dc_generator_input_power",
        translation_key="dc_generator_input_power",
        json_key="dc_generator_input_power",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
    ...
    # AX170 Power Dock additional branch circuit load sensors.
    AnkerSolixSensorDescription(
        key="home_demand_circuit_01",
        translation_key="home_demand_circuit_01",
        json_key="home_demand_circuit_01",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
    ...
    AnkerSolixSensorDescription(
        key="home_demand_circuit_02",
        translation_key="home_demand_circuit_02",
        json_key="home_demand_circuit_02",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
    ...
    AnkerSolixSensorDescription(
        key="home_demand_circuit_03",
        translation_key="home_demand_circuit_03",
        json_key="home_demand_circuit_03",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
    ...
    AnkerSolixSensorDescription(
        key="home_demand_circuit_04",
        translation_key="home_demand_circuit_04",
        json_key="home_demand_circuit_04",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
    ...
    AnkerSolixSensorDescription(
        key="home_demand_circuit_05",
        translation_key="home_demand_circuit_05",
        json_key="home_demand_circuit_05",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
    ...
    AnkerSolixSensorDescription(
        key="home_demand_circuit_06",
        translation_key="home_demand_circuit_06",
        json_key="home_demand_circuit_06",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
    ...
    AnkerSolixSensorDescription(
        key="home_demand_circuit_07",
        translation_key="home_demand_circuit_07",
        json_key="home_demand_circuit_07",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
    ...
    AnkerSolixSensorDescription(
        key="home_demand_circuit_08",
        translation_key="home_demand_circuit_08",
        json_key="home_demand_circuit_08",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
    ...
    AnkerSolixSensorDescription(
        key="home_demand_circuit_09",
        translation_key="home_demand_circuit_09",
        json_key="home_demand_circuit_09",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
    ...
    AnkerSolixSensorDescription(
        key="home_demand_circuit_10",
        translation_key="home_demand_circuit_10",
        json_key="home_demand_circuit_10",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
    ...
    AnkerSolixSensorDescription(
        key="home_demand_circuit_11",
        translation_key="home_demand_circuit_11",
        json_key="home_demand_circuit_11",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
    ...
    AnkerSolixSensorDescription(
        key="home_demand_circuit_12",
        translation_key="home_demand_circuit_12",
        json_key="home_demand_circuit_12",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
